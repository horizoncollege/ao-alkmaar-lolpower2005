...
$_SESSION['woorden'] = [
    ...
    "koningskind",
    "ooggetuigenverslag",
    "huisvuilverbrandinginstallatie",
    "radicalisering",
    "parfumeriezaak",
    "historicus",
    ...
    'Aftoppingsouderdomspensioenexedentregeling',
    ...
    "Taumata­whakatangihanga­koauau­o­tamatea­turi­pukakapiki­maungahoro­nuku­pokai­whenua­kitanatahu",
];

$_SESSION['woorden'] = str_split($_SESSION['woorden'][array_rand($_SESSION['woorden'])]);
